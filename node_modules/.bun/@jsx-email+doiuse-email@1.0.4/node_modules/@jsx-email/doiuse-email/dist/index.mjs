...
// src/doiuse.ts
import { ElementType as ElementType2 } from "htmlparser2";
...
var selectorDetectorsMap = {
  ...
  "Chaining selectors": function(selectors) {
    for (const selector of selectors) {
      if (selector.filter((s) => s.type === SelectorType.Attribute && s.name === "class").length >= 2) {
        return true;
      }
    }
    return false;
...
var DoIUseEmail = class {
  ...
  checkHtmlNode(node) {
    ...
    if (node.attributes !== void 0) {
      ...
      if (styleAttr !== void 0) {
        const styleObject = (styleToObject.default ?? styleToObject)(styleAttr.value);
        if (styleObject !== null) {
    ...
    if ("childNodes" in node) {
      for (const childNode of node.childNodes) {
        if (childNode.type === ElementType2.Tag) {
