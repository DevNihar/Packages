...
var import_render = require("@jsx-email/render");

// ../../node_modules/.pnpm/tw-to-css@0.0.12_ts-node@10.9.1/node_modules/tw-to-css/dist/index.mjs
...
var dt = /* @__PURE__ */ __name((t, e) => () => (t && (e = t(t = 0)), e), "dt");
var S = /* @__PURE__ */ __name((t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), "S");
var yr = /* @__PURE__ */ __name((t, e) => {
  for (var r in e)
    gr(t, r, { get: e[r], enumerable: true });
}, "yr");
var Ia = /* @__PURE__ */ __name((t, e, r, n) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let i of Tp(e))
      !Ip.call(t, i) && i !== r && gr(t, i, { get: () => e[i], enumerable: !(n = _p(e, i)) || n.enumerable });
  return t;
}, "Ia");
var H = /* @__PURE__ */ __name((t, e, r) => (r = t != null ? Ap(Pp(t)) : {}, Ia(e || !t || !t.__esModule ? gr(r, "default", { value: t, enumerable: true }) : r, t)), "H");
var $e = /* @__PURE__ */ __name((t) => Ia(gr({}, "__esModule", { value: true }), t), "$e");
var Ma;
var Da = dt(() => {
  ...
  var ja = (Gn(), $e(Ua)), za = Yn(), Ue = class extends Error {
    ...
    showSourceCode(e) {
      ...
      if (e) {
        ...
        o = /* @__PURE__ */ __name((c) => u(p(c)), "o"), l = /* @__PURE__ */ __name((c) => f(c), "l");
      } else
        o = l = /* @__PURE__ */ __name((u) => u, "l");
...
var Ja = S((_b, Qa) => {
  var zp = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict", Vp = /* @__PURE__ */ __name((t, e = 21) => (r = e) => {
    let n = "", i = r;
    for (; i--; )
      n += t[Math.random() * t.length | 0];
    return n;
  }, "Vp"), Wp = /* @__PURE__ */ __name((t = 21) => {
    let e = "", r = t;
    for (; r--; )
...
var Oe = S((Lt, wl) => {
  ...
  __name(bh, "bh");
  var xh = /* @__PURE__ */ __name(function t(e, r) {
...
var Gr = S((Nt, kl) => {
  ...
  function Sl(t) {
    ...
    return (Sl = /* @__PURE__ */ __name(function(i) {
      return i ? r : e;
    }, "Sl"))(t);
  }
  __name(Sl, "Sl");
...
var Yr = S((Ex, Al) => {
  "use strict";
  var em = {}, tm = em.hasOwnProperty, rm = /* @__PURE__ */ __name(function(e, r) {
    if (!e)
      return r;
    var n = {};
    for (var i in r)
    ...
    return n;
  }, "rm"), nm = /[ -,\.\/:-@\[-\^`\{-~]/, im = /[ -,\.\/:-@\[\]\^`\{-~]/, sm = /(^|\\+)?(\\[A-F0-9]{1,6})\x20(?![a-fA-F0-9\x20])/g, Ei = /* @__PURE__ */ __name(function t(e, r) {
...
var Xl = S((Zt) => {
  ...
  function Jl(t) {
    if (typeof WeakMap != "function")
      return null;
    var e = /* @__PURE__ */ new WeakMap(), r = /* @__PURE__ */ new WeakMap();
    return (Jl = /* @__PURE__ */ __name(function(i) {
      return i ? r : e;
    }, "Jl"))(t);
  }
  __name(Jl, "Jl");
...
var su = S((er, iu) => {
  ...
  function nu(t) {
    if (typeof WeakMap != "function")
      return null;
    var e = /* @__PURE__ */ new WeakMap(), r = /* @__PURE__ */ new WeakMap();
    return (nu = /* @__PURE__ */ __name(function(i) {
      return i ? r : e;
    }, "nu"))(t);
  }
  __name(nu, "nu");
...
var lu = S((j) => {
  ...
  __name(ue, "ue");
  var _y = /* @__PURE__ */ __name(function(e) {
    return new gy.default(e);
  }, "_y");
  j.attribute = _y;
  var Ty = /* @__PURE__ */ __name(function(e) {
    return new yy.default(e);
  }, "Ty");
  j.className = Ty;
  var Py = /* @__PURE__ */ __name(function(e) {
    return new vy.default(e);
  }, "Py");
  j.combinator = Py;
  var Iy = /* @__PURE__ */ __name(function(e) {
    return new wy.default(e);
  }, "Iy");
  j.comment = Iy;
  var Ry = /* @__PURE__ */ __name(function(e) {
    return new by.default(e);
  }, "Ry");
  j.id = Ry;
  var Dy = /* @__PURE__ */ __name(function(e) {
    return new xy.default(e);
  }, "Dy");
  j.nesting = Dy;
  var My = /* @__PURE__ */ __name(function(e) {
    return new Sy.default(e);
  }, "My");
  j.pseudo = My;
  var Fy = /* @__PURE__ */ __name(function(e) {
    return new ky.default(e);
  }, "Fy");
  j.root = Fy;
  var Ly = /* @__PURE__ */ __name(function(e) {
    return new Oy.default(e);
  }, "Ly");
  j.selector = Ly;
  var Ny = /* @__PURE__ */ __name(function(e) {
    return new Ey.default(e);
  }, "Ny");
  j.string = Ny;
  var qy = /* @__PURE__ */ __name(function(e) {
    return new Cy.default(e);
  }, "qy");
  j.tag = qy;
  var $y = /* @__PURE__ */ __name(function(e) {
...
var ve = S((rr, mu) => {
  ...
  function hu(t) {
    if (typeof WeakMap != "function")
      return null;
    var e = /* @__PURE__ */ new WeakMap(), r = /* @__PURE__ */ new WeakMap();
    return (hu = /* @__PURE__ */ __name(function(i) {
      return i ? r : e;
    }, "hu"))(t);
  }
  __name(hu, "hu");
  ...
  __name(r0, "r0");
  var ps = /* @__PURE__ */ __name(function(e) {
...
var Su = S((Dx, ys) => {
  ...
  __name(Zr, "Zr");
  function s0(t) {
    return /* @__PURE__ */ __name(function e(r, n, i, a = i) {
      let s = [];
      if (n.each((o) => {
  ...
  function a0(t) {
    ...
    if (r) {
      ...
      if (n && i.all)
        return { type: "noop" };
      let a = /* @__PURE__ */ __name((s) => !!i[s], "a");
      return i.all ? a = /* @__PURE__ */ __name(() => true, "a") : n && (a = /* @__PURE__ */ __name((s) => s === "all" ? false : !i[s], "a")), { type: "withrules", escapes: a };
    }
    return { type: "unknown" };
  }
  __name(a0, "a0");
...
var Cu = S((Mx, Eu) => {
  "use strict";
  var ku = /-(\w|$)/g, Ou = /* @__PURE__ */ __name(function(e, r) {
    return r.toUpperCase();
  }, "Ou"), f0 = /* @__PURE__ */ __name(function(e) {
...
var Qf = S((Sk, Hf) => {
  Hf.exports = /* @__PURE__ */ __name(function t(e, r, n) {
    var i, a, s, o;
...
var Dc = S((FO, Rc) => {
  "use strict";
  var Dn = Object.prototype.hasOwnProperty, Ic = Object.prototype.toString, Ec = Object.defineProperty, Cc = Object.getOwnPropertyDescriptor, Ac = /* @__PURE__ */ __name(function(e) {
    return typeof Array.isArray == "function" ? Array.isArray(e) : Ic.call(e) === "[object Array]";
  }, "Ac"), _c = /* @__PURE__ */ __name(function(e) {
  ...
  Rc.exports = /* @__PURE__ */ __name(function t() {
...
var Mn = S((LO, Mc) => {
  var ya = /* @__PURE__ */ __name(function(t, e) {
...
var jc = S((qO, Uc) => {
  var Ow = /(.*?(?:(?:\([^\)]+\)|\[[^\]]+\]|(?![><+~\s]).)+)(?:(?:(?:\s(?!>>))|(?:\t(?!>>))|(?:\s?>>\s?))(?!\s+))(?![><+~][\s]+?))/, Ew = /* @__PURE__ */ __name(function(t) {
...
var dr = S(($O, zc) => {
  var Cw = jc(), Aw = /* @__PURE__ */ __name(function(t, e) {
    e = e || false;
...
var Gc = S((jO, Bc) => {
  var Tw = { "*": true, ":root": true, html: true }, Pw = /* @__PURE__ */ __name(function(t) {
    return !!Tw[t];
  }, "Pw");
  Bc.exports = Pw;
});
var Hc = S((zO, Yc) => {
  var Iw = /(.*?(?:(?:\([^\)]+\)|\[[^\]]+\]|(?!>>|<|\+|~|\s).)+)(?:(?:(?:>(?!>))|(?:\s?>(?!>)\s?))(?!\s+))(?!(?:>>|<|\+|~)[\s]+?))/, Rw = /* @__PURE__ */ __name(function(t) {
...
var va = S((VO, tp) => {
  ...
  __name(Zc, "Zc");
  var Xc = /* @__PURE__ */ __name(function(t) {
  ...
  }, "Xc"), ep = /* @__PURE__ */ __name(function(t, e, r) {
...
var wa = S((WO, np) => {
  var Fw = va(), rp = dr(), Lw = /* @__PURE__ */ __name(function(t, e, r) {
...
var ba = S((BO, sp) => {
  var ip = /* @__PURE__ */ __name(function(t, e, r) {
    r = r || [];
    var n = false;
...
var xa = S((GO, ap) => {
  var Nw = dr(), qw = /* @__PURE__ */ __name(function(t, e) {
...
var Sa = S((YO, lp) => {
  var op = Mn(), $w = /* @__PURE__ */ __name(function(t, e, r) {
    r = r || function() {
      return true;
    };
...
var ka = S((HO, fp) => {
  ...
  __name(Fn, "Fn");
  var Ln = /* @__PURE__ */ __name(function(t, e, r, n) {
...
var hp = S((QO, dp) => {
  ...
  function Zw(t, e, r, n, i) {
    ...
    var a = /* @__PURE__ */ __name(function(l) {
      return i && i(l), l;
    }, "a"), s = a(cp(t, e)), o;
...
var vp = S((JO, Oa) => {
  ...
  Oa.exports = (t = {}) => {
    ...
    return { postcssPlugin: "postcss-css-variables", Once(r, { decl: n, result: i, rule: a }) {
      ...
      var u = /* @__PURE__ */ __name(function(p) {
...
var Ra = /* @__PURE__ */ __name((t) => ({ extractCSS(e, r = false) {
  let n = /(?:[\s\r\n]*)?(?<prop>[\w-]+)\s*:\s*(?<value>[^;\r\n]+)/gm, i, a = {};
  for (; (i = n.exec(e)) !== null; ) {
...
\r`;
  ...
  let e = new RegExp("@media\\s*(?<conditions>\\([^)]+\\))\\s*{(?<content>(?:[^{}]+|{(?:[^{}]+|{[^{}]*})*})+)}", "gs"), r = /* @__PURE__ */ new Map(), n = /* @__PURE__ */ __name((a) => a.replace(e, (s, o, l) => {
    var f;
...
__name(V0, "V0");
function an(t, e = {}, { validate: r = /* @__PURE__ */ __name(() => true, "r") } = {}) {
  var i;
...
__name($s, "$s");
var gf = /* @__PURE__ */ __name((t) => Object.assign({}, ...Object.entries(t != null ? t : {}).flatMap(([e, r]) => typeof r == "object" ? Object.entries(gf(r)).map(([n, i]) => ({ [e + (n === "DEFAULT" ? "" : `-${n}`)]: i })) : [{ [`${e}`]: r }])), "gf");
var Q = gf;
function M(t) {
...
var wf = { preflight: ({ addBase: t }) => {
  ...
  return function({ addComponents: r, theme: n }) {
    let i = Fe(n("container.screens", n("screens"))), a = t(i), s = e(a, i, n("container.padding")), o = /* @__PURE__ */ __name((u) => {
      let f = s.find((p) => p.minWidth === u);
      return f ? { paddingRight: f.padding, paddingLeft: f.padding } : {};
    }, "o"), l = Array.from(new Set(a.slice().sort((u, f) => parseInt(u) - parseInt(f)))).map((u) => ({ [`@media (min-width: ${u})`]: { ".container": { "max-width": u, ...o(u) } } }));
  ...
  var a;
  let n = /* @__PURE__ */ __name((s) => `${r("prefix")}${re(s)}`, "n"), i = Object.fromEntries(Object.entries((a = e("keyframes")) != null ? a : {}).map(([s, o]) => [s, { [`@keyframes ${n(s)}`]: o }]));
  t({ animate: (s) => {
    let o = $s(s);
...
function fv(t, e = { containsNonOnDemandable: false }, r = 0) {
  let n = [];
  if (t.type === "rule") {
    let i = /* @__PURE__ */ __name(function(a) {
      a.walkPseudos((s) => {
...
function cv(t, e, { variantList: r, variantMap: n, offsets: i, classList: a }) {
  ...
  let f = 0, p = { postcss: R, prefix: o, e: re, config: s, theme: u, corePlugins: (c) => Array.isArray(t.corePlugins) ? t.corePlugins.includes(c) : s(["corePlugins", c], true), variants: () => [], addBase(c) {
    ...
    for (let m in c) {
      let b = /* @__PURE__ */ __name(function(O, { isOnlyPlugin: x }) {
...
function* bn(t, e, r = t) {
  ...
  for (let p of Ev(i, e)) {
    ...
    if (Ys(y)) {
      if (c.length > 1) {
        let b = /* @__PURE__ */ __name(function(O) {
          return O.length === 1 ? O[0] : O.find((x) => {
            let A = d.get(x);
            return x.some(([{ options: E }, I]) => If(I) ? E.types.some(({ type: F, preferOnConflict: Y }) => A.includes(F) && Y) : false);
          });
        }, "b"), [g, w] = c.reduce((O, x) => (x.some(([{ options: E }]) => E.types.some(({ type: I }) => I === "any")) ? O[0].push(x) : O[1].push(x), O), [[], []]), v = (f = b(w)) != null ? f : b(g);
        if (v)
          c = [v];
        else {
          let O = c.map((A) => {
...
var Op = /* @__PURE__ */ __name(({ config: t, options: e }) => ({ twi: Ea(t, e), twj: Cp(t, e) }), "Op");
var Ep = /* @__PURE__ */ __name((...t) => {
  let e = "";
...
var Cp = /* @__PURE__ */ __name((t, e) => (...r) => kp(Ea(t, e)(r)), "Cp");
var Sp = Ea();
var ab = Cp();

// src/css-to-jsx-style.ts
var camelCase = /* @__PURE__ */ __name((string) => string.replace(/-(\w|$)/g, (_, p1) => p1.toUpperCase()), "camelCase");
var convertPropertyName = /* @__PURE__ */ __name((prop) => {
...
var splitDeclarations = /* @__PURE__ */ __name((cssText) => {
  const declarations = [];
  let capturing;
...
var splitDeclaration = /* @__PURE__ */ __name((declaration) => {
  const i = declaration.indexOf(":");
  return [declaration.substr(0, i).trim(), declaration.substr(i + 1).trim()];
}, "splitDeclaration");
var cssToJsxStyle = /* @__PURE__ */ __name((cssText) => splitDeclarations(cssText).map(splitDeclaration).reduce((styles, [name, value]) => {
  if (name && value) {
...
function processElement(element, headStyles, config) {
  const { twi } = Op({
    config
  });
  if (element.props.className) {
    ...
    element = React.cloneElement(element, {
      ...
      className: finalClassNames.length ? finalClassNames.join(" ") : void 0,
...
function processHead(child, responsiveStyles) {
  if (child.type === "head" || child.type.displayName === "Head") {
...
__name(processHead, "processHead");
var Tailwind = /* @__PURE__ */ __name(({ children, config }) => {
  const headStyles = [];
  ...
  const fullHTML = (0, import_render.jsxToString)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: childrenWithInlineStyles }));
